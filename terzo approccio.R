...
#dataset
setwd("C:/Users/aless/Desktop/Data Science/Decision model/Progetto Santa Travelling/Progetto/Consegna/0.1Per report/3.Senza cluster/1.nn + opt [NON TOCCARE]")
